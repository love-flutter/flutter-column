...
class ApiUserInfoMessage {
  ...
  /// 获取未读的私信消息列表
  static Future<StructApiListRetInfo> getMessageList([String lastId]) async {
    return CallServer.commonListApi('messageList');
  }

  /// 获取评论未读消息列表
  static Future<StructApiListRetInfo> getCommentList([String lastId]) async {
    return CallServer.commonListApi('commentList');
  }
}
