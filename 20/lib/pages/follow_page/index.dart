...
class FollowPageIndex extends StatefulWidget {
  ...
  @override
  createState() => FollowPageIndexState();
}

/// 具体的state类
class FollowPageIndexState extends State<FollowPageIndex> {
  /// 首页推荐贴子列表
        ...
        itemBuilder: (BuildContext context, int position) {
          if (position < this.contentList.length) {
            return CommonArticleCard(
                articleInfo: contentList[position], showBottomBar: true);
          }
