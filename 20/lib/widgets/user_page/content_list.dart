...
import 'package:two_you_friend/widgets/common/article_card.dart';
...
class UserPageContentList extends StatefulWidget {
  ...
  /// 构造函数
  const UserPageContentList({Key key, this.id});

  @override
  createState() => UserPageContentListState();
}

/// 具体的state类
class UserPageContentListState extends State<UserPageContentList> {
  /// 首页推荐贴子列表
      ...
      child: ListView.separated(
        ...
        itemBuilder: (BuildContext context, int position) {
          if (position < this.contentList.length) {
            return CommonArticleCard(articleInfo: contentList[position]);
          }
