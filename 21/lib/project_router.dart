...
import 'package:two_you_friend/pages/follow_page/list.dart';
...
import 'package:two_you_friend/pages/user_page/message.dart';
import 'package:two_you_friend/pages/system_config_page/index.dart';
import 'package:two_you_friend/widgets/common/error.dart';
import 'package:two_you_friend/util/struct/router.dart';

import 'package:two_you_friend/pages/test_page/index.dart';
...
const Map<String, StructRouter> routerMapping = {
  ...
  'usermessage': StructRouter(UserPageMessage(), -1, null, true),
  'followlistpage': StructRouter(FollowPageList(), -1, null, true),
  'systemconfigpage': StructRouter(SystemConfigPageIndex(), -1, null, true),
...
class ProjectRouter {
  ...
  /// 注册路由事件
  Map<String, Widget Function(BuildContext)> registerProjectRouter() {
